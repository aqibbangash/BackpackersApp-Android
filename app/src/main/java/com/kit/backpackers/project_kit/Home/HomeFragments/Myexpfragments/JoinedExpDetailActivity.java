...
public class JoinedExpDetailActivity extends AppCompatActivity {
    ...
    public class LoadMyExpedition extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            nDialog =  new MaterialDialog.Builder(JoinedExpDetailActivity.this)
              ...
              /*  if (getData.length() > 0) {
               ...
               //s Toast.makeText(getActivity(), ob.getString("IdExpedition"), Toast.LENGTH_LONG).show();
                ...
                if(ob.getInt("State") == 1){
                    Toast.makeText(JoinedExpDetailActivity.this, "Theek haai", Toast.LENGTH_LONG).show();
