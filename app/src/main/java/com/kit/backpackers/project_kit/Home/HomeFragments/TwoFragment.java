...
public class TwoFragment extends Fragment {
    ...
    int fragNum;
    static TwoFragment init(int val) {
        TwoFragment truitonList = new TwoFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layoutView = inflater.inflate(R.layout.fragment_two,
                container, false);
        ...
        allexp = (ListView) layoutView.findViewById(R.id.joinExpListView);
        return layoutView;
    }
    ...
    public class LoadMyExpedition extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                responseString = HttpRequests.GetJoinedExpd(userid);
            } catch (IOException e) {
                e.printStackTrace();
            }
